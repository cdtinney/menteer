...
# Dump of table mentor_questionnaire
# ------------------------------------------------------------

DROP TABLE IF EXISTS `mentor_questionnaire`;

CREATE TABLE `mentor_questionnaire` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `question` text,
  `type` varchar(60) DEFAULT NULL,
  `position` int(11) DEFAULT '0',
...
# Dump of table mentor_questionnaire_answers
# ------------------------------------------------------------

DROP TABLE IF EXISTS `mentor_questionnaire_answers`;

CREATE TABLE `mentor_questionnaire_answers` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `questionnaire_id` int(11) DEFAULT NULL,
  `answer` text,
  `position` int(11) DEFAULT '0',
...
INSERT INTO `mentor_questionnaire` (`id`, `question`, `type`, `position`, `importance`, `enabled`)
VALUES
...
INSERT INTO `mentor_questionnaire_answers` (`id`, `questionnaire_id`, `answer`, `position`, `enabled`)
VALUES
