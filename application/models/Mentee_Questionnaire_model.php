...
class Mentee_Questionnaire_model extends CI_Model
{

    public function __construct()
    {
        parent::__construct();
        $this->tb = 'mentee_questionnaire';
    ...
    function _index($data) {
        ...
        foreach ($data as $item){
            ...
            $sql = "SELECT * FROM mentee_questionnaire_answers WHERE questionnaire_id = " . $item['id'] . ' ORDER BY position ASC';
