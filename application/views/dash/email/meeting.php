                ...
                <tr>
                    <td width="100%">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <tr>
                                <td>
                                    <table width="450" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        <tbody>
                                        <!-- Title -->
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:left; line-height: 30px;" st-content="fulltext-content">
                                                <p><?=nl2br($message['meeting_desc'])?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <table>
                                                <tr><td>When: </td><td><ul><li><?=$message['nice_date']?> <?=$message['start_time']?><?=$message['start_ampm']?> - <?=$message['end_time']?><?=$message['end_ampm']?></li></ul></td></tr>
                                                <tr><td>Calendar: </td><td><ul><li><?=$user?></li></ul></td></tr>
                                                <tr><td>Who: </td><td><ul><li><?=$message['who'][0]?></li><li><?=$message['who'][1]?></li></ul></td></tr>
                                            </table>
                                        </tr>
                                        <tr><td><a href="<?=base_url()?>ical/q/<?=$message['ical']?>">Add your appointment to your Calendar (.ics download)</a></td></tr>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #000; text-align:center; line-height: 15px;" st-content="fulltext-content">
                                                <p>&nbsp;</p>
                                            </td>
                                        </tr>
