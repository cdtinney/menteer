...
<head>
    ...
    <style type="text/css">
        ...
        a {color: #b92c28;text-decoration: none;text-decoration:none!important;}
        /*STYLES*/
        ...
        @media only screen and (max-width: 640px) {
            a[href^="tel"], a[href^="sms"] {
                ...
                color: #b92c28; /* or whatever your want */
                pointer-events: none;
                cursor: default;
            }
                                    ...
                                    <table width="100" align="left" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="left" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="viewonline" class="mobile-hide">
                                                <a href="<?=base_url()?>dashboard" style="text-decoration: none; color: #666666">My Dashboard</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
    ...
    <table width="186" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
        ...
        <tr>
            <td width="100%" align="center" class="devicewidth">
                <img src="<?=base_url()?>assets/images/email/icon1.png" alt="" border="0" width="50" height="50" style="display:block; border:none; outline:none; text-decoration:none;">
            </td>
        </tr>
        <!-- end of image2 -->
        <tr>
            <td>
                ...
                <table width="186" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                    ...
                    <!-- read more -->
                    <tr>
                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #b92c28;  text-align:center; line-height: 20px;" st-title="3col-readmore1" class="padding-bottom25">
                            <a href="<?=base_url()?>" style="text-decoration:none; color: #b92c28; ">Read More</a>
                        </td>
                    </tr>
                    <!-- end of read more -->
                    </tbody>
        ...
        <tr>
            <td>
                ...
                <table width="186" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                    ...
                    <!-- read more -->
                    <tr>
                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #b92c28;  text-align:center; line-height: 20px;" st-title="3col-readmore2" class="padding-bottom25">
                            <a href="<?=base_url()?>" style="text-decoration:none; color: #b92c28; ">Read More</a>
                        </td>
                    </tr>
                    <!-- end of read more -->
        ...
        <tr>
            <td>
                ...
                <table width="186" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                    ...
                    <!-- read more -->
                    <tr>
                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #b92c28;  text-align:center; line-height: 20px;" st-title="3col-readmore3">
                            <a href="<?=base_url()?>" style="text-decoration:none; color: #b92c28; ">Read More</a>
                        </td>
                    </tr>
                    <!-- end of read more -->
                                                ...
                                                <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                    ...
                                                    <tr>
                                                        <td width="290" height="160" align="center" class="devicewidth">
                                                            <img src="<?=base_url()?>assets/images/email/ipad.png" alt="" border="0" width="290" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                        </td>
                                                    </tr>
                                                    <!-- Content -->
                                                    <tr>
                                                        <td>
                                                            <table width="270" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #b92c28; text-align:center;" st-title="2colreadmore1">
                                                                        <a href="<?=base_url()?>" style="text-decoration:none; color:#b92c28;">Read More</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="270" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #b92c28; text-align:center;" st-title="2colreadmore2">
                                                                        <a href="<?=base_url()?>" style="text-decoration:none; color:#b92c28;">Read More</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
